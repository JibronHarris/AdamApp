...
namespace GR_App
{
    public static class PC_Class_List
    {
        // Making this class static 
        public static List<PC_Class> PCList = new List<PC_Class>();

        public static async Task GetHtmlAsync()
        {

         
          var url = "https://www.gamerankings.com/pc/index.html";
            ...
            foreach (var item in productsHtml_ODD)
            {
                ...
                if (counter == 0)
                {
                    ...
                    PCList.Add(new PC_Class { PC_name = name, PC_rankings = Ranking });
                    counter = counter + 1;
                }
