...
namespace GR_App
{
    class PS4_Class_List
    {

        public static List<PC_Class> PS4List = new List<PC_Class>();

        public static async Task PS4GetHtmlAsync()
        {


            var url = "https://www.gamerankings.com/ps4/index.html";
            ...
            foreach (var item in productsHtml_ODD)
            {
                ...
                if (counter == 0)
                {
                    ...
                    PS4List.Add(new PC_Class { PC_name = name, PC_rankings = Ranking });
                    counter = counter + 1;
                }
